    ...
    <main style={{ fontFamily: "Inter, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif", background: "#FFF4E3", color: "#3B2114" }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "48px 24px 80px" }}>
        ...
        <div style={{ margin: "0 -24px 56px", position: "relative", height: "clamp(240px, 40vw, 440px)", overflow: "hidden" }}>
          <Image src="/casestudy/bando/bando2.webp" alt="TheBando interior, Atlanta Black history museum and restaurant on the Westside" fill sizes="(max-width: 768px) 100vw, 720px" style={{ objectFit: "cover" }} />
        ...
        <div style={{ margin: "0 -24px 56px", position: "relative", height: "clamp(240px, 35vw, 400px)", overflow: "hidden" }}>
          <Image src="/casestudy/bando/bando1.webp" alt="TheBando signature wall, bold white lettering against patterned Atlanta restaurant wallpaper" fill sizes="(max-width: 768px) 100vw, 720px" style={{ objectFit: "cover" }} />
        </div>
        ...
        {/* ── IMAGE 3 ── */}
        <div style={{ margin: "0 -24px 56px", position: "relative", height: "clamp(240px, 35vw, 400px)", overflow: "hidden" }}>
          <Image src="/casestudy/bando/bandocrackpic.webp" alt="TheBando signature crack chicken dish, the No Cap bestseller" fill sizes="(max-width: 768px) 100vw, 720px" style={{ objectFit: "cover" }} />
          <div style={{ position: "absolute", bottom: 16, left: 24, background: "rgba(59,33,20,0.75)", color: "#FFF4E3", fontSize: 12, padding: "6px 12px", borderRadius: 6, backdropFilter: "blur(4px)" }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "0 24px 80px" }}>
        ...
        {/* ── LEAD FORM CTA ── */}
        <BlogLeadForm
          source="blog:restaurant-atlanta"
