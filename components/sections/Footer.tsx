      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-8 px-6 md:px-12 pb-20">
        ...
        <div className="relative flex flex-col gap-3 pl-0 md:pl-8">
          ...
          <div className="flex flex-col gap-8 sm:flex-row sm:gap-14">
            ...
            <div className="flex flex-col gap-3">
              ...
              >
                <li>
                  <a href="/pricing" className="hover:text-gray-400 transition-colors duration-300">Pricing</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/industries" className="hover:text-gray-400 transition-colors duration-300">Industries</a>
                </li>
                <li>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center gap-5">
            ...
            {DISCORD_INVITES.siteFooter && (
            <a href={DISCORD_INVITES.siteFooter} target="_blank" rel="noopener noreferrer" aria-label="Join CTRL·A on Discord" className="transition hover:scale-110">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                viewBox="0 0 640 512"
