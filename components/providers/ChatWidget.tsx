  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    if (headingMatch) {
      ...
      blocks.push(
        <HeadingTag
          key={`h-${lineKey++}`}
          className={`font-bold text-white ${level === 1 ? 'text-lg mt-4 mb-2' :
      ...
      {open && (
        <div className="fixed bottom-6 right-6 w-[450px] max-w-[92vw] h-[600px] max-h-[85vh] rounded-[2rem] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.8)] border border-white/10 bg-black/60 backdrop-blur-3xl flex flex-col overflow-hidden z-[999999]">
          ...
          <div className="flex items-center justify-between px-8 py-5 border-b border-white/5 bg-transparent text-white">
            <span style={{ fontFamily: "Norwige, sans-serif", fontWeight: "bold", color: "rgba(255,255,255,0.9)" }}>
          ...
          >
            {messages.length === 0 && (
              <div className="space-y-4">
                <div className="text-sm text-white/60 font-medium px-2" style={{ fontFamily: "Roboto, sans-serif" }}>
            ...
            {loading && (
              <div className="flex justify-start px-2">
                <div className="text-xs text-white/40 animate-pulse" style={{ fontFamily: "Roboto, sans-serif" }}>
                  Thinking…
                </div>
              </div>
            )}
          ...
          <div className="p-6 border-t border-white/5 bg-transparent">
            <div className="flex gap-3 items-end">
              ...
              >
                <span className="font-semibold text-sm" style={{ fontFamily: "Roboto, sans-serif" }}>Send</span>
              </button>
            </div>
            <div className="mt-3 px-1 text-[clamp(0.7rem,1.5vw,0.75rem)] text-white/30 tracking-wide" style={{ fontFamily: "Roboto, sans-serif" }}>
