...
export interface AlbumCoverLoopProps {
    logos: LogoItem[];
    speed?: number;
...
export const AlbumCoverLoop = React.memo<AlbumCoverLoopProps>(
    ({
        logos,
        speed = 120,
        direction = 'left',
...
AlbumCoverLoop.displayName = 'AlbumCoverLoop';

export default AlbumCoverLoop;
