...
const tiers = [
  {
    ...
    price: 2000,
    shootDuration: "Half-day (4hrs)",
    featured: false,
    tagline: "Quick, professional content for your next campaign.",
    bestFor: "Businesses needing quick, professional content for social media",
    features: [
      "Half-day shoot (4 hours)",
      "10 edited photos OR 1 edited video",
      "5 social media assets",
      "Brand color grading",
      "Brand overlay treatment",
    ],
  },
  {
    name: "Brand Content Suite",
    price: 5000,
    shootDuration: "Full-day (8hrs)",
    featured: true,
    tagline: "A full content library in a single shoot day.",
    bestFor: "Brands building a consistent visual presence across platforms",
    features: [
      "Full-day shoot (8 hours)",
      "25 edited photos AND 2 edited videos",
  ...
  },
  {
    name: "Content Engine",
    price: 8000,
    shootDuration: "2-day shoot",
    featured: false,
    tagline: "Content that drives revenue all quarter long.",
    bestFor: "Businesses that want content to drive revenue all quarter long",
    features: [
      "2-day shoot",
      "50 edited photos + 4 edited videos",
      ...
      <div className="max-w-6xl mx-auto">
                    ...
                    <span
                      dangerouslySetInnerHTML={{
                        __html: item
                          .replace(
                            /\bAND\b/g,
                            '<strong class="text-white/70">AND</strong>'
                          )
                          .replace(
                            /\bOR\b/g,
        ...
        >
          <span className="text-white/30 text-xs uppercase tracking-[0.15em]">
            Market rate:{" "}
            <span className="text-white/50 font-medium">$3,000 – $15,000</span>
          </span>
