          ...
          {faqs.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Answer always in the DOM (collapsed with a CSS grid-rows
                    transition, not unmounted) so crawlers and AI answer engines
                    read it. Pure CSS = no hydration mismatch. */}
                <div
