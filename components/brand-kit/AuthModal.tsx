    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md bg-[#1B0E2E] border-[rgba(240,230,224,0.15)] text-[#F0E6E0]">
        <DialogHeader className="flex flex-col items-center text-center space-y-4 pt-4">
          <div className="w-16 h-16 rounded-full bg-[rgba(240,230,224,0.1)] flex items-center justify-center border border-[rgba(240,230,224,0.2)]">
            <LogIn className="size-8 text-[#F0E6E0]" />
          </div>
        ...
        <DialogFooter className="flex flex-col sm:flex-row gap-3 pt-6">
          ...
          <Button 
            ...
            className="w-full sm:flex-1 shadow-[0_4px_20px_rgba(36,18,58,0.5)] bg-[#F0E6E0] text-[#24123A] hover:bg-[#F0E6E0]"
          >
